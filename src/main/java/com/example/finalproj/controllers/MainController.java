...
import com.example.finalproj.models.Cart;
...
import com.example.finalproj.repositories.CartRepository;
import com.example.finalproj.repositories.OrderRepository;
import com.example.finalproj.repositories.ProductRepository;
import com.example.finalproj.security.PersonDetails;
            ...
            if(!price.isEmpty()){
                if(price.equals("sorted_by_ascending_price")) {
                    if (!contract.isEmpty()) {
                        ...
                        } else if (contract.equals("sleeper")) {
